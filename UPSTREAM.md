...
The Go and Python SDKs agree on the VM/ZEC Action sets and the corresponding
...
runtime array maps: VM 213 models / 625 fields and ZEC 761 models / 2,419
fields, with zero type or mapping differences. The ZEC total includes the one
...
relationships (VM 501 and ZEC 1,968 field relationships), also with zero
differences. These checks are independent of the Go-to-PHP generator audit.
...
The generator validates both services before replacing output, refuses unknown
